...
検査の根拠は隣接成果物 `設計と検査結果.md`、およびパッケージ内 `verification.json`。初版main基準394203274a5bd4d1eff4dd51fe64e07127c65275、新ヘッダー併用確認版71de9c96021ef3e725af6ffda88e46076161575f。実際の統合では必ず最新版を読み直す。
