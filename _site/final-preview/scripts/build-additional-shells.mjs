...
const frameCss=await readFile(resolve(pkg,'frame.css'),'utf8'),contactCss=await readFile(resolve(pkg,'contact.css'),'utf8'),privacyCss=await readFile(resolve(pkg,'privacy.css'),'utf8'),categoryCss=await readFile(resolve(pkg,'category.css'),'utf8');
...
for(const path of paths){
 const original=await readFile(resolve(root,path),'utf8'),en=path.startsWith('en/'),service=path.startsWith('services/'),contactPage=path==='contact/index.html'||path==='en/contact/index.html',privacyPage=path==='privacy-policy/index.html'||path==='en/privacy-policy/index.html',categoryPage=path.startsWith('categories/')||path.startsWith('en/categories/'),home=path==='index.html'||path==='en/index.html';
