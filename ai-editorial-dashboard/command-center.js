(()=>{
  ...
  function syncComposerLock(){
    ...
    document.querySelectorAll('.weeklyButton').forEach(b=>{if(!b.dataset.unlockedTitle)b.dataset.unlockedTitle=b.title||'';b.disabled=locked||b.dataset.weekCompleted==='1';b.title=active?'現在の案件が完了または終了するまで新しい曜日案件は開始できません。':b.dataset.unlockedTitle});
