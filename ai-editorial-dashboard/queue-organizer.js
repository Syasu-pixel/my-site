(()=>{
  ...
  const routines=[
    ...
    {day:2,label:'火',short:'新記事',text:'火曜の新記事制作を開始。調査済み候補と現在のサイト構成から、管理者が指定した件数の新記事を制作してください。件数指定がない場合は1記事のみ制作してください。公式資料確認から記事制作、必要画像、技術確認、Gemini検証、最終監査、GitHub PR、Netlify Previewまで既定ルールで進め、管理者確認が必要な段階ではPreviewを提示して停止してください。1記事につき1案件キューとし、修正・再試行で新しい案件を生成しないでください。'},
  ...
  import('./queue-preview-media.js?v=0.7.9').catch(e=>console.warn('[AI編集部] queue preview media load failed',e));
})();