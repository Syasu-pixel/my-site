# AI Editorial Live Debate Test

Temporary infrastructure-only test for the visible Round 2 editorial discussion.

## Synthetic proposal under review
For this test only, consider whether infrastructure changes should be allowed to skip the independent CHALLENGER and REVIEWER stages and be merged automatically after the EDITOR proposes them.
