...
- 作業中の記事は `本文更新済み / 関連記事画像カード済み / 追加画像は保留` のように途中状態を残す。
...
- [ ] `articles/dc24v-common-basic.html` — DC24Vコモン — 作業中（本文見直し / 関連記事画像カード化 / 追加画像は保留）
...
作業中: `articles/dc24v-common-basic.html`

本文先行で進め、追加画像だけ後回しにする。
