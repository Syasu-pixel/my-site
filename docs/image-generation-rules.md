...
- hero採用後の後続画像でも、採用済みheroに加えて共通キャラクターテンプレートを継続参照する。
- キャラクターは図解を補助する役割とし、画像の主役は記事テーマ・図解・フロー・比較・チェック項目にする。
...
キャラクター禁止（強化）：
- ヘルメットに `SENIOR` / `JUNIOR` / `SENPAI` / `KOHAI` / 名前ラベルを入れない
- 3Dリアル人物にしない
- 写真風人物にしない
- 海外アニメ風にしない
- 頭身を高くしない
...
- 新しい第三の人物を追加しない
- 先輩と後輩を同じ顔・同じ服装にしない
- 先輩と後輩の性別・役割が分かりにくい構図にしない
- キャラクターを中央に大きく置きすぎない
- 図解や文字よりキャラクターを目立たせない
