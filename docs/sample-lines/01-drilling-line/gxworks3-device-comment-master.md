...
| D319 | CY05動作回数 |
| D320～D329 | SPARE |
| D330 | A101_T1搬送タイムアウト回数 |
| D331 | A102_T2搬送タイムアウト回数 |
| D332 | A103_T3搬送タイムアウト回数 |
| D333 | A104_T4搬送タイムアウト回数 |
| D334 | A111_ST01異常回数 |
| D335 | A112_ST02異常回数 |
| D336 | A113_ST03異常回数 |
| D337 | A114_ST04異常回数 |
...
| D341 | A203_CY03異常回数 |
| D342 | A204_CY04異常回数 |
| D343 | A205_CY05下降異常回数 |
| D344 | A206_CY05上昇異常回数 |
| D345 | A210_加工位置未成立回数 |
| D346 | A301_低エア圧異常回数 |
| D347 | A401_INV01異常回数 |
| D348 | A402_INV02異常回数 |
...
D300～D365の意味・更新条件は `gxworks3-maintenance-device-map.md` を正とする。
...
特にM440～M476、M500～M517、M700帯、M800帯、M900/M920/M940/M960/M980帯、D300～D365は記事・GOT・ラダーで共通参照するため、番号を途中で変更しない基準とする。
