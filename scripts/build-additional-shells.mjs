...
for(const path of paths){
 const original=await readFile(resolve(root,path),'utf8'),en=path.startsWith('en/'),service=path.startsWith('services/'),contactPage=path==='contact/index.html',privacyPage=path==='privacy-policy/index.html',categoryPage=path.startsWith('categories/')||path.startsWith('en/categories/'),home=path==='index.html'||path==='en/index.html';
