...
try{for(const p of proposals)for(const [device,viewport]of Object.entries(base.environment.viewports)){
 ...
 if(!await page.locator('.dc-consult').isVisible())throw Error('Consultation hidden');
 ...
 if(p.lang==='en'&&!/Japanese/.test(await page.locator('.dc-consult').innerText()))throw Error('Japanese consultation must be labeled');
