...
const pending=[];
const allowedAdditional=['index.html','en/index.html',service,'contact/index.html','en/contact/index.html','privacy-policy/index.html','en/privacy-policy/index.html','categories/career.html','categories/air-pneumatic.html','categories/circuit-basics.html','categories/comparison-guide.html','categories/control-basics.html','categories/tools-guide.html','en/categories/circuit-basics.html','en/categories/control-basics.html'];
